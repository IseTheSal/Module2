...
//    @BeforeEach
//    public void setUp() {
//        dao = Mockito.mock(UserRepository.class);
//        service = new UserServiceImpl(dao, roleRepository, null, passwordEncoder);
//    }
//
//    @Test
//    void findById() {
//        Mockito.when(dao.findById(1L)).thenReturn(Optional.of(firstUser));
